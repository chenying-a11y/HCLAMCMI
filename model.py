...
class HCLAMCMI(nn.Module):
    ...
    def forward(self, mi_original_features, circ_original_features, mi_sim_features, circ_sim_features,
                ...
                G_mi_Kn_node2vec, G_mi_Km_node2vec, G_circ_Kn_node2vec, G_circ_Km_node2vec, miRNA_node2vec_tensor, circRNA_node2vec_tensor,
               ):
        ...
        mi_feature1_original, mi_feature2_original, mi_cl_loss_original = self.CL_HGCN_mi_original(mi_original_features, G_mi_original_Kn, mi_original_features,G_mi_original_Km)
        circ_feature1_original, circ_feature2_original, circ_cl_loss_original = self.CL_HGCN_circ_original(circ_original_features, G_circ_original_Kn, circ_original_features, G_circ_original_Km)

        mi_feature1_sim,mi_feature2_sim, mi_cl_loss_sim = self.CL_HGCN_mi_sim(mi_sim_features,G_mi_sim_Kn, mi_sim_features,G_mi_sim_Km)
        circ_feature1_sim, circ_feature2_sim, circ_cl_loss_sim = self.CL_HGCN_circ_sim(circ_sim_features,G_circ_sim_Kn,circ_sim_features, G_circ_sim_Km)

        mi_feature1_node2vec, mi_feature2_node2vec, mi_cl_loss_node2vec = self.CL_HGCN_mi_node2vec(mi_node2vec_features, G_mi_Kn_node2vec, mi_node2vec_features,G_mi_Km_node2vec)
        circ_feature1_node2vec, circ_feature2_node2vec, circ_cl_loss_node2vec = self.CL_HGCN_circ_node2vec(circ_node2vec_features , G_circ_Kn_node2vec,circ_node2vec_features , G_circ_Km_node2vec)
        ...
        mi_cl_loss_new = mi_cl_loss_original + mi_cl_loss_sim + mi_cl_loss_node2vec
        circ_cl_loss_new = circ_cl_loss_original + circ_cl_loss_sim + circ_cl_loss_node2vec
